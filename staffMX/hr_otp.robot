...
${Allow_Value}             50050001512   
${Taxno_FIELD}             id=tax_number            
${Taxno_Value}             9909901353   
${Curp_FIELD}              id=curp
${Curp_Value}              9909901353   
${TaxAdd_FIELD}            id=tax_zipcode                    
${TaxAdd_Value}            9909901353 
${Insuno_FIELD}            id=insurance_number                
${Insuno_Value}            9909901353 
${IDcard_FIELD}            id=id_card                
${IDcard_Value}            9909901353     
${BankAcc_FIELD}           id=bank_account                              
${BankAcc_FValue}          9909901353 
${BankNo_FIELD}            id=bank_account_number                  
${BankNo_Value}            9909901353 
