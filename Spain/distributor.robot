...
${Distributor_TYPE_DROPDOWN}          id:distributor_type
...
Fill Distributor Details
    ...
    Select From List By Value    ${Distributor_TYPE_DROPDOWN}    1    # เลือก "Distribuidor" ตาม value="1"
    Log To Console    Selected "Distribuidor" for Distributor Type. (เลือก "Distributor" สำหรับประเภท distributor แล้ว)
    ...
    Input Text    ${email}          ksrc034@gmail.com
    Log To Console    Selected ksrc034@gmail.com for email. (เลือก ksrc034@gmail.com สำหรับอีเมล)
    ...
    Input Text    ${Tel}         0654389470
    Log To Console    Selected 0654389470 for Phone number. (เลือก 0654389470 สำหรับเบอร์โทรศัพท์แล้ว)
